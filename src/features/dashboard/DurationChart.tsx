...
const prepareData = (startData: { duration: string; value: number; color: string }[], stays: IBooking[]) => {
  const incArrayValue = (arr: typeof startData, field: string) => {
...
const DurationChart = ({ confirmedStays }: { confirmedStays: IBooking[] }) => {
